...
Sukututkijan apuväline, joka kokoaa yhteen kymmenen hautatietoja tarjoavaa verkkopalvelua. Haun voi kohdistaa Suomeen tai Ruotsiin: Suomessa mukana ovat kaikki alla luetellut palvelut, Ruotsissa haudat.fi:n Ruotsin seurakunnat (n. 310 seurakuntaa, sama hakukone kuin gravar.se), Tukholman kaupungin Hittagraven, Geneanet ja Find a Grave. Avustaja kertoo, mistä palveluista etsityn kunnan hautausmaat löytyvät, ja avaa kunkin palvelun oikeaan kohtaan – valmiiksi täytettynä, jos palvelu sen sallii.
...
| [haudat.fi](https://haudat.fi/) | Virallinen hautarekisteri, Suomesta 11 pienempää seurakuntaa; sama hakukone kattaa myös Ruotsin seurakuntien hautausmaat (ruotsinkielinen käyttöliittymä [gravar.se](https://gravar.se/)) | Vitec Software |
...
| [Hittagraven](https://etjanster.stockholm.se/Hittagraven/home) | Tukholman kaupungin 11 yleisen hautausmaan virallinen hautarekisteri (Ruotsi-haku) | Stockholms stad, Kyrkogårdsförvaltningen |
...
2. Valitse maa (Suomi tai Ruotsi), kirjoita sukunimi ja/tai valitse kunta. Kunnan valinta näyttää heti, missä palveluissa kunnan hautausmaat ovat.
...
kunta-vastaavuudet.json  käsin ylläpidettävä taulukko: postitoimipaikka -> kunta, seurakunta -> kunnat,
                         lakkautettu kunta -> nykyinen kunta, Ruotsin seurakunta -> kommun
...
Skripti lukee kunkin palvelun oman hautausmaaluettelon (hautakartta.fi:n seurakuntarajapinta, hautahaku.fi:n sovelluspaketin taulukko, haudat.fi:n seurakuntasivut, suomenkiha.fi:n hakemisto, Hautakivitietokannan hautausmaaluettelo, Geneanetin maakuntasivu, opasteapp.fi:n seurakuntasivut ja suvusto.fi:n kuvauspaikkaluettelo sekä Ruotsin osalta haudat.fi:n Ruotsi-osio, Geneanetin Ruotsi-sivu ja Hittagravenin hautausmaaluettelo), vertaa sitä edelliseen versioon ja tulostaa muutokset. Jos jokin lähde ei toimi, sen edelliset tiedot säilyvät ja skripti varoittaa. Kun luetteloon ilmestyy uusi seurakunta tai postitoimipaikka, jolle ei ole kuntavastaavuutta, skripti pyytää lisäämään sen `kunta-vastaavuudet.json`-tiedostoon.

Valitsimilla `--only` ja `--skip` voi rajata päivityksen tiettyihin palveluihin.

## Miten avustaja toimii palveluiden kanssa

Avustaja rakentaa kullekin palvelulle linkin, jonka käyttäjä avaa itse. Palvelut ovat kahdenlaisia: kuntaan kohdistettavia (hautausmaaluettelo tunnetaan kunnittain, jolloin avustaja avaa palvelun oikeaan seurakuntaan) ja alueen mukaan kohdistamattomia (haku aina koko maasta: Find a Grave sekä Suomessa Geneanet).

Hautakivitietokanta, Geneanet, Find a Grave ja Hittagraven tukevat osoiteparametreja, joten linkki avaa hakusivun hakuehdot valmiiksi täytettyinä. Suvusto.fi:ssä jokaisella sukunimellä on oma sivunsa, joten linkki avaa suoraan sukunimen kuvat.
...
Kuntaindeksi perustuu palveluiden hautausmaaluetteloihin ja käsin ylläpidettyihin kuntaliitostietoihin. Ruotsin kuntaindeksi kattaa vain ne kunnat, joiden seurakuntia on haudat.fi:ssä tai hautausmaita Geneanetissä. Jos jokin lakkautettu kunta ohjaa väärään nykyiseen kuntaan, korjaus tehdään `kunta-vastaavuudet.json`-tiedostoon.

Kattavuusluettelo vanhenee hitaasti; Asetukset ja tiedot -osio näyttää, milloin se on päivitetty.

## Osallistuminen

Virheilmoitukset ja parannusehdotukset ovat tervetulleita. Erityisen hyödyllisiä ovat havainnot palveluiden muuttuneesta rakenteesta (päivitysskriptin varoitukset) ja puuttuvista kuntavastaavuuksista.
...
Jari Aro, jari.t.aro (at) gmail.com
